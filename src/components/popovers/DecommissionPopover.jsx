...
import './DecommissionPopover.css';

function DecommissionPopover({ isOpen, onClose, data }) {
  if (!isOpen || !data) return null;

  return createPortal(
    <div className="decommission-popover-overlay" onClick={onClose}>
      <div className="decommission-popover-container" onClick={(e) => e.stopPropagation()}>
        <div className="decommission-popover-arrow" />
        <div className="decommission-popover-card">
          <div className="decommission-popover-content">
            {/* Header Section */}
            <div className="decommission-popover-header">
              <div className="decommission-popover-status-section">
                <div className="decommission-popover-status-badge">
                  <div className="decommission-popover-status-icon">
                  ...
                  <span className="decommission-popover-status-text">{data.status}</span>
                </div>
                <h1 className="decommission-popover-title">{data.title}</h1>
              </div>

              {/* Info Section */}
              <div className="decommission-popover-info-grid">
                <div className="decommission-popover-info-item">
                  <div className="decommission-popover-info-label">
                    <div className="decommission-popover-info-icon">
                      <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span className="decommission-popover-info-label-text">Operadora</span>
                  </div>
                  <div className="decommission-popover-info-details">
                    <div className="decommission-popover-info-value">{data.operator}</div>
                    <div className="decommission-popover-info-description">{data.operatorDescription}</div>
                  </div>
                </div>
                ...
                <div className="decommission-popover-info-item">
                  <div className="decommission-popover-info-label">
                    ...
                    <span className="decommission-popover-info-label-text">Profundidade</span>
                  </div>
                  <div className="decommission-popover-info-details">
                    <div className="decommission-popover-info-value">{data.depth}</div>
                    <div className="decommission-popover-info-description">{data.depthDescription}</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="decommission-popover-participation">
              <h2 className="decommission-popover-participation-title">Participação das empresas</h2>
              <div className="decommission-popover-companies">
                {data.companies?.map((company) => (
                  <div key={company.id} className="decommission-popover-company">
                    <div className="decommission-popover-company-header">
                      <span className={`decommission-popover-company-name ${company.isOperator ? 'operator' : ''}`}>
                        {company.name}
                      </span>
                      <span className="decommission-popover-company-percentage">
                        {company.percentage}%
                      </span>
                    </div>
                    <div className="decommission-popover-progress-bar">
                      <div 
                        className="decommission-popover-progress-fill"
                        style={{
            ...
            {/* Close Button */}
            <button className="decommission-popover-close-button" onClick={onClose}>
              Fechar
            </button>
          </div>
        </div>
...
export default DecommissionPopover;
