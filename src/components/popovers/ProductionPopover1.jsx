...
import './ProductionPopover.css';

function ProductionPopover({ isOpen, onClose, data }) {
  if (!isOpen || !data) return null;

  return createPortal(
    <div className="production-popover-overlay" onClick={onClose}>
      <div className="production-popover-container" onClick={(e) => e.stopPropagation()}>
        <div className="production-popover-arrow" />
        <div className="production-popover-card">
          <div className="production-popover-content">
            {/* Header Section */}
            <div className="production-popover-header">
              <div className="production-popover-status-section">
                <div className="production-popover-status-badge">
                  <div className="production-popover-status-icon">
                  ...
                  <span className="production-popover-status-text">{data.status}</span>
                </div>
                <h1 className="production-popover-title">{data.title}</h1>
              </div>

              {/* Info Section */}
              <div className="production-popover-info-grid">
                <div className="production-popover-info-item">
                  <div className="production-popover-info-label">
                    <div className="production-popover-info-icon">
                      <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span className="production-popover-info-label-text">Operadora</span>
                  </div>
                  <div className="production-popover-info-details">
                    <div className="production-popover-info-value">{data.operator}</div>
                    <div className="production-popover-info-description">{data.operatorDescription}</div>
                  </div>
                </div>
                ...
                <div className="production-popover-info-item">
                  <div className="production-popover-info-label">
                    ...
                    <span className="production-popover-info-label-text">Profundidade</span>
                  </div>
                  <div className="production-popover-info-details">
                    <div className="production-popover-info-value">{data.depth}</div>
                    <div className="production-popover-info-description">{data.depthDescription}</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Divider */}
            <div className="production-popover-divider" />

            {/* Company Participation Section */}
            <div className="production-popover-participation">
              <h2 className="production-popover-participation-title">Participação das empresas</h2>
              <div className="production-popover-companies">
                {data.companies?.map((company) => (
                  <div key={company.id} className="production-popover-company">
                    <div className="production-popover-company-header">
                      <span className={`production-popover-company-name ${company.isOperator ? 'operator' : ''}`}>
                        {company.name}
                      </span>
                      <span className="production-popover-company-percentage">
                        {company.percentage}%
                      </span>
                    </div>
                    <div className="production-popover-progress-bar">
                      <div 
                        className="production-popover-progress-fill"
                        style={{
            ...
            {/* Infrastructure Section (if exists) */}
            {data.infrastructure && (
              <>
                <div className="production-popover-divider" />
                <div className="production-popover-infrastructure">
                  <h2 className="production-popover-infrastructure-title">Infraestrutura associada</h2>
                  <div className="production-popover-infrastructure-content">
                    <div className="production-popover-fpso-info">
                      <div className="production-popover-fpso-title">{data.infrastructure.fpsoCount} FPSO em operação</div>
                      <div className="production-popover-fpso-description">{data.infrastructure.fpsoDescription}</div>
                    </div>
                    {data.infrastructure.items?.map((item, index) => (
                      <div key={index} className="production-popover-bullet-item">
                        <div className="production-popover-bullet-number">
                          <span>{item.number}</span>
                        </div>
                        <span className="production-popover-bullet-text">{item.name}</span>
                      </div>
                    ))}
                  </div>
                </div>
            ...
            {/* Close Button */}
            <button className="production-popover-close-button" onClick={onClose}>
              Fechar
            </button>
          </div>
        </div>
...
export default ProductionPopover;
