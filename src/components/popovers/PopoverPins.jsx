...
function PopoverPins({ isOpen, anchorEl, onClose, data, language }) {
  ...
  const status = data.status?.label || data.status || translate("StatusNaoDefinido");
      ...
      <div className="popover-pins-card">
              ...
              {operatorName && (
                <div className="popover-pins-info-block">
                  <div className="popover-pins-info-header">
                    ...
                    <span className="popover-pins-info-label">{translate("Operadora")}</span>
                  </div>
              ...
              {depthValue && (
                <div className="popover-pins-info-block">
                  <div className="popover-pins-info-header">
                    ...
                    <span className="popover-pins-info-label">{translate("Profundidade")}</span>
                  </div>
                  <div className="popover-pins-info-content">
        ...
        {hasCompanies && (
          <div className="popover-pins-section">
            <h2 className="popover-pins-section-title">{translate("ParticipacaoEmpresas")}</h2>
            <div className="popover-pins-companies">
              ...
              {hasInfrastructure && (
                <div className="popover-pins-section">
                  <h2 className="popover-pins-section-title">{translate("InfraestruturaAssociada")}</h2>
