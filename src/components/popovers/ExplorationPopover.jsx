...
import './ExplorationPopover.css';

function ExplorationPopover({ isOpen, onClose, data }) {
  if (!isOpen || !data) return null;

  return createPortal(
    <div className="exploration-popover-overlay" onClick={onClose}>
      <div className="exploration-popover-container" onClick={(e) => e.stopPropagation()}>
        <div className="exploration-popover-arrow" />
        <div className="exploration-popover-card">
          <div className="exploration-popover-content">
            {/* Header Section */}
            <div className="exploration-popover-header">
              <div className="exploration-popover-status-section">
                <div className="exploration-popover-status-badge">
                  <div className="exploration-popover-status-icon">
                  ...
                  <span className="exploration-popover-status-text">{data.status}</span>
                </div>
                <h1 className="exploration-popover-title">{data.title}</h1>
              </div>

              {/* Info Section */}
              <div className="exploration-popover-info-grid">
                <div className="exploration-popover-info-item">
                  <div className="exploration-popover-info-label">
                    <div className="exploration-popover-info-icon">
                      <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span className="exploration-popover-info-label-text">Operadora</span>
                  </div>
                  <div className="exploration-popover-info-details">
                    <div className="exploration-popover-info-value">{data.operator}</div>
                    <div className="exploration-popover-info-description">{data.operatorDescription}</div>
                  </div>
                </div>
                ...
                <div className="exploration-popover-info-item">
                  <div className="exploration-popover-info-label">
                    ...
                    <span className="exploration-popover-info-label-text">Profundidade</span>
                  </div>
                  <div className="exploration-popover-info-details">
                    <div className="exploration-popover-info-value">{data.depth}</div>
                    <div className="exploration-popover-info-description">{data.depthDescription}</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="exploration-popover-participation">
              <h2 className="exploration-popover-participation-title">Participação das empresas</h2>
              <div className="exploration-popover-companies">
                {data.companies?.map((company) => (
                  <div key={company.id} className="exploration-popover-company">
                    <div className="exploration-popover-company-header">
                      <span className={`exploration-popover-company-name ${company.isOperator ? 'operator' : ''}`}>
                        {company.name}
                      </span>
                      <span className="exploration-popover-company-percentage">
                        {company.percentage}%
                      </span>
                    </div>
                    <div className="exploration-popover-progress-bar">
                      <div 
                        className="exploration-popover-progress-fill"
                        style={{
            ...
            {/* Close Button */}
            <button className="exploration-popover-close-button" onClick={onClose}>
              Fechar
            </button>
          </div>
        </div>
