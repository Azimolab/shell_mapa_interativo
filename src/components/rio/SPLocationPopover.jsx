    ...
    <>
      ...
      <div className="md:gap-3 max-[480px]:py-2.5 max-[480px]:gap-2.5 max-[360px]:p-2 flex flex-col gap-2">
        ...
        <div className="flex flex-col gap-1.5 max-[480px]:gap-2.5">
          <h2 className="text-grey-600 font-[ShellMedium,'-apple-system',Roboto,Helvetica,sans-serif] text-[10px] md:text-[16px] max-[480px]:text-[14px] max-[360px]:text-xs font-medium leading-normal m-0 whitespace-nowrap">Subsidiárias diretas</h2>
